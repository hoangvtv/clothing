...
<%@include file="/WEB-INF/views/include/men.jsp"%> 
	<br>
		...
		<!-- Khai báo pagedListHolder với param p -->
			...
			<c:url value="home/search.htm" var="pagedLink">
                                ...
                                <div class="col-6 col-lg-4 col-xl-4 mb-4 mb-sm-8">
                                    ...
                                    <div class="product-item product-st3-item">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="prices">
                                                <span class="price"><f:formatNumber value="${s.price }" type="currency" currencySymbol="đ" maxFractionDigits="0"/></span>
                                ...
                                <div class="product-widget">
                                    ...
                                    <ul class="product-widget-category">
                                    	<c:forEach var="c" items="${listCategory }">
											<li><a href="home/category/product.htm?id=${c.id }"><span>${c.name}</span></a></li>
										</c:forEach>
                                    </ul>
                                </div>
