                    ...
                    <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <p class="breadcrumbs"><span><a href="admin/dashboard.htm">Trang chủ</a></span>
                                <span><i class="mdi mdi-chevron-right"></i></span>Danh Mục</p>
                        </div>
                        <div>
												...
												<div class="row my-3">
									  			...
									  			<div class="row mb-3">
										    		...
										    		<div class="col-sm-8">
										    			...
										    			<img id="img" class="rounded" src="resources/images/categories/defaul.png" style="width: 250px; height: 250px; "/>
										    		</div>
									  			</div>
