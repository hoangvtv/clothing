                    ...
                    <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <p class="breadcrumbs"><span><a href="admin/dashboard.htm">Trang chủ</a></span>
                                <span><i class="mdi mdi-chevron-right"></i></span>Chỉnh sửa sản phẩm</p>
                        </div>
                        <div>
											...
											<div class="row mb-3">
								  			...
								  			<div class="row mb-3">
									    		...
									    		<div class="col-sm-8">
													...
													<img id="img" class="rounded" src="resources/images/products/${product.image}" style="width: 300px; height:350px">
