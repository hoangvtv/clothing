   ...
   <%@include file="/WEB-INF/views/admin/common/common_css.jsp"%>
          ...
          <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
            ...
            <div>
              ...
              <a href="admin/newBrand.htm" class="btn btn-primary">Thêm thương hiệu</a>
            </div>
          </div>
          
          <jsp:useBean id="pagedListHolder" scope="request" type="org.springframework.beans.support.PagedListHolder" />

			<c:url value="admin/listBrand.htm" var="pagedLink">
                  ...
                  <table id="responsive-data-table" class="table"
                      ...
                      <tbody>
                        <c:forEach var="s" items="${pagedListHolder.pageList}">
                          <tr>
                            <td> <a href="admin/listProduct.htm"><span>${s.brand_id }</span></a></td>
							<td> ${s.name }</td>
							<td> ${s.description }</td>
                            <td>
                              <div class="btn-group mb-1">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item btn btn-info" href="admin/editBrand.htm?id=${s.brand_id }">Sửa</a>
                                  <a type="button" class="dropdown-item btn btn-danger" data-bs-toggle="modal"
                                     data-bs-target="#modal-delete-product" data-id="admin/deleteBrand.htm?id=${s.brand_id }" href="#modal-delete-product">Xoá</a>
                                </div>
                              </div>
                            </td>
                          </tr>
