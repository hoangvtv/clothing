...
<base href="${pageContext.servletContext.contextPath}/">
   ...
   <%@include file="/WEB-INF/views/admin/common/common_css.jsp"%>
		...
		<div class="h4 text-uppercase text-center" style="width:100%">Danh sách đơn hàng</div>
				...
				<table class="table table-hover mt-3">
					...
					<c:forEach var="p1" items="${pagedListHolder1.pageList}">
						<tr class="table-light text-center">
							...
							<td class="">
								<a class="btn btn-outline-success mt-auto" href="admin/acceptOrder.htm?id=${p1.id }"><span>Chấp nhận</span></a>
								<a class="btn btn-outline-danger mt-auto" href="admin/denyOrder.htm?id=${p1.id }"><span>Hủy</span></a>
							</td>
						</tr>	
					</c:forEach>						
				</table>
				...
				<table class="table table-hover mt-3">
					...
					<c:forEach var="p2" items="${pagedListHolder2.pageList}">
						<tr class="table-light text-center">
							...
							<td class="">
								<a class="btn btn-outline-success mt-auto" href="admin/acceptOrder.htm?id=${p2.id }"><span>Chấp nhận</span></a>
								<a class="btn btn-outline-danger mt-auto" href="admin/denyOrder.htm?id=${p2.id }"><span>Hủy</span></a>
							</td>
						</tr>	
					</c:forEach>						
				</table>
