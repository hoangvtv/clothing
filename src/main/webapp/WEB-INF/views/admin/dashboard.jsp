...
<base href="${pageContext.servletContext.contextPath}/">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-sm-6 p-b-15 lbl-card">
                                <div class="card card-mini dash-card card-1">
                                    <div class="card-body">
                                        <h2 class="mb-1">${totalUsers} User</h2>
                                        <p>Tổng người dùng</p>
                            ...
                            <div class="col-xl-4 col-sm-6 p-b-15 lbl-card">
                                <div class="card card-mini dash-card card-3">
                                    <div class="card-body">
                                        <h2 class="mb-1">${totalOrders} Đơn hàng</h2>
                                        <p>Tổng đơn hàng</p>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body align-self-center">
                                                                    <a href="admin/user/detail?userId=${u.id}">
    ...
    <script>
         var barColors = ["#88aaf3", "#50d7ab", "#9586cd", "#f3d676", "#ed9090", "#a4d9e5"];
         new Chart("doChart", {
             type: "doughnut",
             data: {
               labels: ["đã hoàn thành", "đang gửi", "sẵn sàng", "đang chờ xử lý", "đã hủy"],
               datasets: [{
