   ...
   <%@include file="/WEB-INF/views/admin/common/common_css.jsp"%>
          ...
          <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
            ...
            <div>
              ...
              <a href="admin/newUser.htm" class="btn btn-primary">Thêm người dùng</a>
            </div>
          </div>
                  ...
                  <table id="responsive-data-table" class="table"
                      ...
                      <tbody>
                        <c:forEach var="s" items="${pagedListHolder.pageList}">
                          <tr>
                            <td ><a href="admin/detailUser.htm?id=${s.id }"><span>${s.id }</span></a></td>
							<td >${s.lastName }</td>
							<td >${s.firstName }</td>
							<td >${s.phone }</td>
							<td >${s.email }</td>
                            ...
                            <td>
                              <div class="btn-group mb-1">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item btn btn-info" href="admin/editUser.htm?id=${s.id }">Sửa</a>
                                  <a type="button" class="dropdown-item btn btn-danger" data-bs-toggle="modal"
                                     data-bs-target="#modal-delete-product" data-id="admin/deleteUser.htm?id=${s.id }" href="#modal-delete-product">Xoá</a>
                                </div>
                              </div>
                            </td>
                          </tr>
